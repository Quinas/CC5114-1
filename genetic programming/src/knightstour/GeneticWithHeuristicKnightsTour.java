...
public class GeneticWithHeuristicKnightsTour {
  ...
  public GeneticWithHeuristicKnightsTour(int boardSize, double mutationRate) {
  ...
  public int findTour(int iterations) {
    ...
    BitSequenceFitness fitness = new GeneticWithHeuristicFitness(boardSize, x, y);
    int maxFitness = 0;
